...
#define ZXV__INITCPY( NAME, DLL ) ZXV___INITCPY( NAME, DLL, NAME##__initCpy )

#define ZXV___KILL( NAME, DLL, FUN ) DLL void FUN##( NAME *src )
#define ZXV__KILL( NAME, DLL ) ZXV___KILL( NAME, DLL, NAME##__kill )
...
#define ZXV_PUSH_BACK( NAME, DLL ) \
  ZXV__PUSH_BACK( NAME, DLL, NAME##_push_back )
